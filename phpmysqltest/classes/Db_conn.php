...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'rjdonnelly';//this will be your WCC username
      $dbUsr = 'rjdonnelly';//this will be your WCC username
      $dbPass = 'Jzj7zBHx3gVa';//this will be the password found in the video.
